...
namespace GrainRestaurants.Infrastructure.Migrations
{
    ...
    [Migration("20210826001957_AddSeedsDish")]
    partial class AddSeedsDish
    {
            ...
            modelBuilder.Entity("GrainRestaurants.Core.Entities.Dish", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 196, DateTimeKind.Local).AddTicks(7742),
                            ...
                            Items = "Frango empanado e dourado com molho suave e cremoso, acompanhado de alface fresquinho, fatias de bacon crocante num pão com gergelim, acompanhamento e bebida.",
                        ...
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5346),
                        ...
                        {
                            Id = 3L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5364),
                            ImageUrl = "https://static-images.ifood.com.br/image/upload/t_medium/pratos/1a003463-20d8-4744-841a-6ac212a66c4b/202108101448_P6S1_f.png",
                            Items = "Frango empanado e dourado com o maravilhoso molho cheddar McMelt, cebola shoyo num pão com gergelim, acompanhamento e bebida. Consulte informações nutricionais do refrigerante 400ml em: mcdonalds.com.br/cardapio/bebidas. Não utilize o campo de observações, as alterações devem ser realizadas no pedido.",
                        ...
                        {
                            Id = 4L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5367),
                            ...
                            Items = "O maior sanduíche de carne 100% bovina do mcdonald’s agora também com creme de muçarela, 2 deliciosas fatias de queijo cheddar e emental, tomate, alface, cebola e o delicioso molho tasty. Mais acompanhamento e bebida em sua McOferta.",
                        ...
                        {
                            Id = 5L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5369),
                            ...
                            Items = "Um delicioso hambúrguer feito com picanha, 4 fatias crocantes de bacon, nosso cremoso cheddar, cebola crispy e pão com gergelim.",
                        ...
                        {
                            Id = 6L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5374),
                            ...
                            Items = "A novidade com Kitkat chega para gerar momentos deliciosos... Venha dar um Break com Kitkat e Mcdonald's! Calda de Chocolate!",
                        ...
                        {
                            Id = 7L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5376),
                            ...
                            Items = "A novidade com Kitkat chega para gerar momentos deliciosos... Venha dar um Break com Kitkat e Mcdonald's! Calda de Morango!",
                        ...
                        {
                            Id = 8L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5378),
                            ...
                            Items = "Uma delícia gelada sabor baunilha, uma supercamada de cobertura de chocolate, caramelo ou morango e ainda por cima com farofa de paçoca.O canudo completa a tentação.",
                        ...
                        {
                            Id = 9L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5379),
                            ...
                            Items = "O novo McShake é feito com leite e batido na hora. Você pode escolher nos sabores Ovomaltine , Chocolate Kopenhagen ou morango.",
                        ...
                        {
                            Id = 10L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 197, DateTimeKind.Local).AddTicks(5382),
            ...
            modelBuilder.Entity("GrainRestaurants.Core.Entities.Restaurant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            AddressId = 1L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 206, DateTimeKind.Local).AddTicks(4021),
                        ...
                        new
                        {
                            Id = 2L,
                            AddressId = 2L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 206, DateTimeKind.Local).AddTicks(4932),
                        ...
                        new
                        {
                            Id = 3L,
                            AddressId = 3L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 206, DateTimeKind.Local).AddTicks(4938),
                        ...
                        new
                        {
                            Id = 4L,
                            AddressId = 4L,
                            CreatedAt = new DateTime(2021, 8, 25, 21, 19, 57, 206, DateTimeKind.Local).AddTicks(4940),
